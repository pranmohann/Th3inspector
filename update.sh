...
echo -e "$red [$green+$red]$Cleaning Up Old Directories ...";
  ...
  git clone https://github.com/pranmohann/Th3inspector "/data/data/com.termux/files/usr/share/Th3inspector";
...
echo -e "$red [$green+$red]$off Cleaning Up Old Directories ...";
  ...
  echo -e "$red [$green+$red]$off Installing ...";
 sudo git clone https://github.com/pranmohann/Th3inspector "/usr/share/Th3inspector";
